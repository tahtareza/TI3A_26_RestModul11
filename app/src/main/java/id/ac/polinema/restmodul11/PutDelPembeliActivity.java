package id.ac.polinema.restmodul11;
...
import id.ac.polinema.restmodul11.Rest.ApiInterface;
...
// else Picasso.with(mContext).load(R.drawable.photoid).into(mPhotoid);
        if (mIntent.getStringExtra("photo_id").length() > 0)
            Glide.with(mContext).load(ApiClient.BASE_URL+"application/"+mIntent.getStringExtra("photo_id")).into(mPhotoid);
    ...
    private void setListener() {
        ...
        btUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                RequestBody reqIdPembeli = MultipartBody.create(MediaType.parse("multipart/form-data"), (edtIdPembeli.getText().toString().isEmpty() == true) ? "" : edtIdPembeli.getText().toString());
                RequestBody reqNama = MultipartBody.create(MediaType.parse("multipart/form-data"), (edtNama.getText().toString().isEmpty() == true) ? "" : edtNama.getText().toString());
                RequestBody reqAlamat = MultipartBody.create(MediaType.parse("multipart/form-data"), (edtAlamat.getText().toString().isEmpty() == true) ? "" : edtAlamat.getText().toString());
                RequestBody reqTelpn = MultipartBody.create(MediaType.parse("multipart/form-data"), (edtTelpn.getText().toString().isEmpty() == true) ? "" : edtTelpn.getText().toString());
        ...
        btDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Call<ResultPembeli> callDelete = mApiInterface.deletePembeli(reqIdPembeli, reqAction);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == 10) {
            ...
            if (cursor != null) {
                ...
                //Picasso.with(mContext).load(newFile(imagePath)).fit().into(mImageView);
